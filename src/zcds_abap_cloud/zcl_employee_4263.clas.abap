CLASS zcl_employee_4263 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_employee_4263 IMPLEMENTATION.
  METHOD if_oo_adt_classrun~main.

    MODIFY zemployee_4263 FROM TABLE @(  VALUE #( ( employee = '1' manager = ''   name = 'Name 1' )
                                                  ...
                                                  ( employee = '10' manager = '8' name = 'Name10' ) ) ).
